...
public interface ApplicationService {
    ...
    ApplyResponse applyUpload(Long jobId, ApplyUploadRequest request, MultipartFile file, Principal principal);

    MoveApplicationStageResponse moveStage(Long applicationId, MoveApplicationStageRequest request,
            Principal principal);

    InterviewScheduleResponse createInterview(Long applicationId, CreateInterviewRequest request, Principal principal);

    InterviewScheduleResponse updateInterview(Long applicationId, Long interviewId, CreateInterviewRequest request,
            Principal principal);
}
